    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="page-header" style="margin-top: 0px">
                <h1><strong>Heatmap Analysis</strong>
                    <small>
            ...
            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" class="btn btn-default btn-xs"
                                                                onclick="addsamples('${muestras.gridFS_Sample._id}','${patientList.id}')">
                                                                <span class="glyphicon glyphicon-plus"
                                                                      aria-hidden="true"></span>
                                                            &nbsp;Add
                                                        </button>
                ...
                <form id="cluster_heatmap" name="cluster_heatmap" method="get"> <!--action="./action/redirectResults.jsp"
                    ...
                    <div class="form-group">
                        <label class="col-sm-offset-2 col-sm-8" for="optionlabel">Select label to display: </label>
                        <select multiple class="col-sm-offset-4 col-sm-8" style="width: 50%" id="optionlabel">
                        </select>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-offset-2 col-sm-2 control-label">Select analysis</label>
                        <div class="col-sm-offset-4 col-sm-8">
                            <label class="control-label">
                                <input type="checkbox" id="heatMap" disabled> Generate Heatmap
                            </label>
                        </div>

                        <div class="col-sm-offset-4 col-sm-8">
                            <p class="help-block">
                                Select at least two gene expression samples to activate the service.
                            </p>
                        </div>
            ...
            <div class="modal-body">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 align="center">How to perform a Heatmap Analysis?</h4>
                    </div>
                    <div class="panel-body">
                        In this link users can find how to perform a Heatmap Analysis.
                        <a href="https://youtu.be/4bxuH9TVkc8?t=771" target="_blank">FIMED tutorial (Heatmap Analysis)</a>
                    </div>
                </div>
            </div>
