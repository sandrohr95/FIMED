    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="page-header" style="margin-top: 0px">
                <h1><strong>Dendrogram + Heatmap Analysis</strong>
                    <small>
            ...
            <div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" class="btn btn-default btn-xs"
                                                                onclick="addsamplesDendroGram('${muestras.gridFS_Sample._id}','${patientList.id}')">
                                                                <span class="glyphicon glyphicon-plus"
                                                                      aria-hidden="true"></span>
                                                            &nbsp;Add
                                                        </button>
                ...
                <form id="cluster_heatmap" name="cluster_heatmap" method="get"> <!--action="./action/redirectResults.jsp"
                            ...
                            <div class="table-responsive">
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <button type="button" class="btn btn-default btn-xs"
                                                    onclick="deletesamplesDendrogram()">
                                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>&nbsp;delete
                                            </button>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody id="SamplesDendrogram">
                    ...
                    <div class="form-group">
                        <label class="col-sm-offset-2 col-sm-2 control-label">Services</label>
                        <div class="col-sm-offset-4 col-sm-8">
                            <label class="control-label">
                                <input type="checkbox" id="dendrogram" disabled>
                                Dendrogram HeatMap
                            </label>
                        </div>
                        <div class="col-sm-offset-4 col-sm-8">
            ...
            <div class="modal-body">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 align="center">How to perform a ClusterHeatmap Analysis?</h4>
                    </div>
                    <div class="panel-body">
                        In this link users can find how to perform a ClusterHeatmap Analysis.
                        <a href="https://youtu.be/4bxuH9TVkc8?t=912" target="_blank">FIMED tutorial (ClusterHeatmap Analysis)</a>
                    </div>
                </div>
            </div>
